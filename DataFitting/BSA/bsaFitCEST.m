...
s1=Spin( 0.87,     15,  0.0,   [0 0 4.3e7] );  %water
s2=Spin(  1.1,        8e3,   -3.5,       [0 0 7.1e5]);
s3=Spin(  1.1,        2.8e3,    2.4,       [0 0 7.1e+05]);
s4=Spin( 0.87,   1e5       ,   0.0   ,  [0 0 1e8       ] );

sim=ZSpecBlochSim( s1, s2, s3, s4 );
sim.add_kex(2,1, 10, 2, 50);
sim.add_kex(2,3, 5,1, 50);
sim.add_kex(3,1, 60, 1, 400);
...
s4.opt_vals('x') = 0; s4.set_lb_ub('x',-4,1);
